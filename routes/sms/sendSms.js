...
const { sendBills, sendToAll, sendBill, sendBillPerDay, sendToGroup, sendToOne, sendUnpaidCustomers, sendLowBalanceCustomers, sendHighBalanceCustomers, sendCustomersAboveBalance, sendBillsEstate, sendToEstate, sendCustomersAboveBalanceDetailed, sendCustomersAboveBalanceCoreWaste } = require('../../controller/sms/sms.js');
...
router.post('/send-sms-custom-balance-corewaste',verifyToken,sendCustomersAboveBalanceCoreWaste,)                       // 2️⃣ loads req.tenantStatus from DB)
